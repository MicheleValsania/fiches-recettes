...
const messages = {
  it: {
    ...
    "lang.fr": "Francese",
    "lang.en": "Inglese",
    "auth.title": "Accesso riservato",
    "auth.subtitle": "Inserisci la password per continuare.",
    "auth.placeholder": "Password",
    "auth.submit": "Entra",
    "auth.invalidPassword": "Password errata.",
    "app.compactOn": "Vista compatta",
    "app.compactOff": "Vista standard",
    ...
    "app.searchCategory": "Cerca per categoria...",
    "app.sort.updated": "Ordina: ultima modifica",
    "app.sort.alphabetical": "Ordina: alfabetico",
    "app.sort.publication": "Ordina: pubblicazione",
    "app.prevFiche": "Fiche precedente",
    "app.nextFiche": "Fiche successiva",
    ...
    "app.exportSupplierOrderPdf": "PDF ordine",
    "app.supplierOrderPdfTitle": "Elenco prodotti per ordine",
    "app.supplierOrderPdfColCode": "Codice fornitore",
    "app.supplierOrderPdfColName": "Nome prodotto",
    "app.supplierOrderPdfColResidual": "Prodotto residuo",
    "app.supplierOrderPdfColToOrder": "Nuova quantita da ordinare",
    "app.backToSuppliers": "Torna ai fornitori",
    "app.productPlaceholder": "Prodotto...",
    "app.supplierCodePlaceholder": "Codice fornitore",
    "app.originalPricePlaceholder": "Prezzo origine",
    "app.originalUnitLabel": "Unita origine",
    ...
    "status.noSupplierProductsToExport": "Nessun prodotto da esportare per questo fornitore.",
    "status.supplierOrderPdfExported": "PDF ordine fornitore esportato ({count} prodotti).",
    "status.supplierOrderPdfExportError": "Errore durante l'export del PDF ordine fornitore.",
    ...
    "form.categorySelectPlaceholder": "- Scegli una categoria -",
    "form.categoryCurrentValue": "Attuale: {value}",
    "form.categoryGroupCommon": "Comune",
    "form.categoryGroupRistorante": "Ristorante",
    "form.categoryGroupSnackBar": "Snack Bar",
    "form.portions": "Porzioni",
    "form.ingredients": "Ingredienti",
    "form.addIngredient": "+ Aggiungi ingrediente",
    "form.ingredientPlaceholder": "Ingrediente (testo ricetta)",
    "form.productPlaceholder": "Prodotto fornitore",
    ...
    "form.haccpProfiles": "Profili HACCP (conservazione/condizionamento)",
    "form.addHaccpProfile": "+ Aggiungi profilo HACCP",
    "form.haccpPackaging": "Condizionamento (es: sottovuoto, GN coperto)",
    "form.haccpTempMin": "Temp min C",
    "form.haccpTempMax": "Temp max C",
    "form.haccpCoreTemp": "Temp cuore C",
    "form.haccpHoldMin": "Tenuta min",
    "form.haccpShelfLifeValue": "Durata",
    "form.haccpShelfLifeUnit": "Unita durata",
    "form.haccpDlcType": "Tipo (DLC/DDM)",
    "form.haccpStartPoint": "Decorrenza",
    "form.haccpNotes": "Note HACCP",
    "form.haccpUnit.hours": "ore",
    "form.haccpUnit.days": "giorni",
    "form.haccpUnit.months": "mesi",
    "form.haccpStart.production_date": "data produzione",
    "form.haccpStart.cooling_end": "fine raffreddamento",
    "form.haccpStart.opening_date": "data apertura",
    "form.haccpStart.thaw_date": "data scongelamento",
    "form.haccpStart.receipt_date": "data ricevimento",
    "form.haccpStart.freezing_date": "data surgelazione",
    "form.haccpProcess.COOK_CHILL": "Cottura e conservazione refrigerata",
    "form.haccpProcess.MARINATION": "Marinatura",
    "form.haccpProcess.VACUUM_PASTEURIZATION": "Pastorizzazione sottovuoto",
    "form.haccpProcess.SOUS_VIDE_COOK": "Cottura sottovuoto",
    "form.haccpProcess.FREEZING": "Surgelazione",
    "form.haccpProcess.THAWING": "Scongelamento",
    "form.haccpProcess.HOT_HOLDING": "Mantenimento caldo",
    "form.haccpProcess.OTHER": "Altro processo",
    "form.storageProfiles": "Profili conservazione",
    "form.addStorageProfile": "+ Aggiungi profilo conservazione",
    "form.storageId": "ID profilo",
    "form.storageMode": "Modalita (es: FRESH_0_3)",
    "form.storageTransforms": "Trasformazioni consentite (CSV)",
    "form.storageSource": "Origine profilo",
    "form.showAdvanced": "Mostra avanzato",
    "form.showBasic": "Mostra base",
    "form.labelHints": "Suggerimenti etichetta",
    "form.labelType": "Tipo etichetta",
    "form.labelDisplayName": "Display name",
    "form.labelLegalName": "Nome legale",
    "form.labelAllergenMode": "Allergeni (auto/manual/hide)",
    "form.labelAllergenManual": "Testo allergeni manuale",
    "form.labelProduction": "Etichetta produzione",
    "form.labelDlc": "Etichetta DLC/DDM",
    "form.labelDefaultStorage": "Profilo conservazione di default",
    "form.labelQrTarget": "Target QR",
    "form.labelTemplate": "Template hint",
    "form.labelShowInternalLot": "Mostra lotto interno",
    "form.labelShowSupplierLot": "Mostra lotto fornitore",
    "form.labelShowTempRange": "Mostra range temperatura",
    "form.notes": "Note (opz.)",
    ...
    "preview.haccpProfiles": "Profili HACCP",
    "preview.storageProfiles": "Profili conservazione",
    "preview.labelHints": "Suggerimenti etichetta",
    "preview.notes": "Note",
  },
  fr: {
    "lang.it": "Italien",
    ...
    "app.compactOn": "Vue compacte",
    "app.compactOff": "Vue normale",
    ...
    "app.searchCategory": "Rechercher par categorie...",
    "app.sort.updated": "Tri: derniere mise a jour",
    "app.sort.alphabetical": "Tri: alphabetique",
    "app.sort.publication": "Tri: publication",
    "app.prevFiche": "Fiche precedente",
    "app.nextFiche": "Fiche suivante",
    ...
    "app.exportSupplierOrderPdf": "PDF commande",
    "app.supplierOrderPdfTitle": "Liste produits pour commande",
    "app.supplierOrderPdfColCode": "Code fournisseur",
    "app.supplierOrderPdfColName": "Nom produit",
    "app.supplierOrderPdfColResidual": "Produit residuel",
    "app.supplierOrderPdfColToOrder": "Nouvelle quantite a commander",
    "app.backToSuppliers": "Retour aux fournisseurs",
    "app.productPlaceholder": "Produit...",
    "app.supplierCodePlaceholder": "Code fournisseur",
    "app.originalPricePlaceholder": "Prix origine",
    "app.originalUnitLabel": "Unite origine",
    ...
    "status.noSupplierProductsToExport": "Aucun produit a exporter pour ce fournisseur.",
    "status.supplierOrderPdfExported": "PDF commande fournisseur exporte ({count} produits).",
    "status.supplierOrderPdfExportError": "Erreur pendant l'export du PDF commande fournisseur.",
    ...
    "form.categorySelectPlaceholder": "- Choisir une categorie -",
    "form.categoryCurrentValue": "Actuelle: {value}",
    "form.categoryGroupCommon": "Commun",
    "form.categoryGroupRistorante": "Ristorante",
    "form.categoryGroupSnackBar": "Snack Bar",
    "form.portions": "Portions",
    "form.ingredients": "Ingredients",
    "form.addIngredient": "+ Ajouter ingredient",
    "form.ingredientPlaceholder": "Ingredient (texte recette)",
    "form.productPlaceholder": "Produit fournisseur",
    ...
    "form.haccpProfiles": "Profils HACCP (conservation/conditionnement)",
    "form.addHaccpProfile": "+ Ajouter profil HACCP",
    "form.haccpPackaging": "Conditionnement (ex: sous vide, bac GN ferme)",
    "form.haccpTempMin": "Temp min C",
    "form.haccpTempMax": "Temp max C",
    "form.haccpCoreTemp": "Temp coeur C",
    "form.haccpHoldMin": "Maintien min",
    "form.haccpShelfLifeValue": "Duree",
    "form.haccpShelfLifeUnit": "Unite duree",
    "form.haccpDlcType": "Type (DLC/DDM)",
    "form.haccpStartPoint": "Point de depart",
    "form.haccpNotes": "Notes HACCP",
    "form.haccpUnit.hours": "heures",
    "form.haccpUnit.days": "jours",
    "form.haccpUnit.months": "mois",
    "form.haccpStart.production_date": "date production",
    "form.haccpStart.cooling_end": "fin refroidissement",
    "form.haccpStart.opening_date": "date ouverture",
    "form.haccpStart.thaw_date": "date decongelation",
    "form.haccpStart.receipt_date": "date reception",
    "form.haccpStart.freezing_date": "date de surgelation",
    "form.haccpProcess.COOK_CHILL": "Cuisson et conservation au froid",
    "form.haccpProcess.MARINATION": "Marinade",
    "form.haccpProcess.VACUUM_PASTEURIZATION": "Pasteurisation sous vide",
    "form.haccpProcess.SOUS_VIDE_COOK": "Cuisson sous vide",
    "form.haccpProcess.FREEZING": "Surgelation",
    "form.haccpProcess.THAWING": "Decongelation",
    "form.haccpProcess.HOT_HOLDING": "Maintien au chaud",
    "form.haccpProcess.OTHER": "Autre process",
    "form.storageProfiles": "Profils conservation",
    "form.addStorageProfile": "+ Ajouter profil conservation",
    "form.storageId": "ID profil",
    "form.storageMode": "Mode (ex: FRESH_0_3)",
    "form.storageTransforms": "Transformations autorisees (CSV)",
    "form.storageSource": "Source profil",
    "form.showAdvanced": "Afficher avance",
    "form.showBasic": "Afficher base",
    "form.labelHints": "Suggestions etiquette",
    "form.labelType": "Type etiquette",
    "form.labelDisplayName": "Display name",
    "form.labelLegalName": "Nom legal",
    "form.labelAllergenMode": "Allergenes (auto/manual/hide)",
    "form.labelAllergenManual": "Texte allergenes manuel",
    "form.labelProduction": "Libelle production",
    "form.labelDlc": "Libelle DLC/DDM",
    "form.labelDefaultStorage": "Profil conservation par defaut",
    "form.labelQrTarget": "Cible QR",
    "form.labelTemplate": "Template hint",
    "form.labelShowInternalLot": "Afficher lot interne",
    "form.labelShowSupplierLot": "Afficher lot fournisseur",
    "form.labelShowTempRange": "Afficher plage temperature",
    ...
    "preview.haccpProfiles": "Profils HACCP",
    "preview.storageProfiles": "Profils conservation",
    "preview.labelHints": "Suggestions etiquette",
    "preview.notes": "Notes",
  },
  en: {
    "lang.it": "Italian",
    ...
    "app.compactOn": "Compact view",
    "app.compactOff": "Standard view",
    ...
    "app.searchCategory": "Search by category...",
    "app.sort.updated": "Sort: last updated",
    "app.sort.alphabetical": "Sort: alphabetical",
    "app.sort.publication": "Sort: publication",
    "app.prevFiche": "Previous fiche",
    "app.nextFiche": "Next fiche",
    ...
    "app.exportSupplierOrderPdf": "Order PDF",
    "app.supplierOrderPdfTitle": "Order product list",
    "app.supplierOrderPdfColCode": "Supplier code",
    "app.supplierOrderPdfColName": "Product name",
    "app.supplierOrderPdfColResidual": "Residual product",
    "app.supplierOrderPdfColToOrder": "New quantity to order",
    "app.backToSuppliers": "Back to suppliers",
    "app.productPlaceholder": "Product...",
    "app.supplierCodePlaceholder": "Supplier code",
    "app.originalPricePlaceholder": "Source price",
    "app.originalUnitLabel": "Source unit",
    ...
    "status.noSupplierProductsToExport": "No product to export for this supplier.",
    "status.supplierOrderPdfExported": "Supplier order PDF exported ({count} products).",
    "status.supplierOrderPdfExportError": "Error exporting supplier order PDF.",
    ...
    "form.categorySelectPlaceholder": "- Choose a category -",
    "form.categoryCurrentValue": "Current: {value}",
    "form.categoryGroupCommon": "Common",
    "form.categoryGroupRistorante": "Ristorante",
    "form.categoryGroupSnackBar": "Snack Bar",
    "form.portions": "Portions",
    "form.ingredients": "Ingredients",
    "form.addIngredient": "+ Add ingredient",
    "form.ingredientPlaceholder": "Ingredient (recipe text)",
    "form.productPlaceholder": "Supplier product",
    ...
    "form.haccpProfiles": "HACCP profiles (storage/packaging)",
    "form.addHaccpProfile": "+ Add HACCP profile",
    "form.haccpPackaging": "Packaging (ex: vacuum, closed GN tray)",
    "form.haccpTempMin": "Temp min C",
    "form.haccpTempMax": "Temp max C",
    "form.haccpCoreTemp": "Core temp C",
    "form.haccpHoldMin": "Holding min",
    "form.haccpShelfLifeValue": "Shelf life",
    "form.haccpShelfLifeUnit": "Shelf life unit",
    "form.haccpDlcType": "Type (DLC/DDM)",
    "form.haccpStartPoint": "Start point",
    "form.haccpNotes": "HACCP notes",
    "form.haccpUnit.hours": "hours",
    "form.haccpUnit.days": "days",
    "form.haccpUnit.months": "months",
    "form.haccpStart.production_date": "production date",
    "form.haccpStart.cooling_end": "cooling end",
    "form.haccpStart.opening_date": "opening date",
    "form.haccpStart.thaw_date": "thaw date",
    "form.haccpStart.receipt_date": "receipt date",
    "form.haccpStart.freezing_date": "freezing date",
    "form.haccpProcess.COOK_CHILL": "Cook and chill",
    "form.haccpProcess.MARINATION": "Marination",
    "form.haccpProcess.VACUUM_PASTEURIZATION": "Vacuum pasteurization",
    "form.haccpProcess.SOUS_VIDE_COOK": "Sous-vide cooking",
    "form.haccpProcess.FREEZING": "Freezing",
    "form.haccpProcess.THAWING": "Thawing",
    "form.haccpProcess.HOT_HOLDING": "Hot holding",
    "form.haccpProcess.OTHER": "Other process",
    "form.storageProfiles": "Storage profiles",
    "form.addStorageProfile": "+ Add storage profile",
    "form.storageId": "Profile ID",
    "form.storageMode": "Mode (ex: FRESH_0_3)",
    "form.storageTransforms": "Allowed transformations (CSV)",
    "form.storageSource": "Profile source",
    "form.showAdvanced": "Show advanced",
    "form.showBasic": "Show basic",
    "form.labelHints": "Label hints",
    "form.labelType": "Label type",
    "form.labelDisplayName": "Display name",
    "form.labelLegalName": "Legal name",
    "form.labelAllergenMode": "Allergens mode (auto/manual/hide)",
    "form.labelAllergenManual": "Manual allergens text",
    "form.labelProduction": "Production label",
    "form.labelDlc": "DLC/DDM label",
    "form.labelDefaultStorage": "Default storage profile",
    "form.labelQrTarget": "QR target",
    "form.labelTemplate": "Template hint",
    "form.labelShowInternalLot": "Show internal lot",
    "form.labelShowSupplierLot": "Show supplier lot",
    "form.labelShowTempRange": "Show temperature range",
    "form.notes": "Notes (opt.)",
    ...
    "preview.haccpProfiles": "HACCP profiles",
    "preview.storageProfiles": "Storage profiles",
    "preview.labelHints": "Label hints",
    "preview.notes": "Notes",
  },
} as const;
